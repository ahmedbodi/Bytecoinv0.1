...
unlocked to sign the ByteCoin-Qt.app bundle.
...
allowing somebody to distribute a ByteCoin-Qt.app or bytecoin-qt-setup.exe with a valid
...
that the bytecoin-qt.exe file inside the installer had not been tampered with.
