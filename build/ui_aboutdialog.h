...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel2->setMouseTracking(true);
        copyrightLabel2->setTextFormat(Qt::RichText);
        copyrightLabel2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        verticalLayout_2->addWidget(copyrightLabel2);
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Bytecoin", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("AboutDialog", "<html><head/><body><p><span style=\" font-weight:600;\">Bytecoin</span> version</p></body></html>", 0, QApplication::UnicodeUTF8));
        copyrightLabel2->setText(QApplication::translate("AboutDialog", "Copyright &copy; 2013 The Bytecoin developers", 0, QApplication::UnicodeUTF8));
