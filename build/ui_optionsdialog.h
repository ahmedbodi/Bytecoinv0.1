...
**
** Created: Wed Sep 11 17:25:01 2013
...
public:
    ...
    ByteCoinAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_1_Main;
    QCheckBox *bytecoinAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new ByteCoinAmountField(tabMain);
        ...
        bytecoinAtStartup = new QCheckBox(tabMain);
        bytecoinAtStartup->setObjectName(QString::fromUtf8("bytecoinAtStartup"));

        verticalLayout_Main->addWidget(bytecoinAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bytecoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start ByteCoin after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        bytecoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Bytecoin on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the ByteCoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the ByteCoin network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting ByteCoin.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show ByteCoin addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
