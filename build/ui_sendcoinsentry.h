...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        payAmount = new ByteCoinAmountField(SendCoinsEntry);
    ...
    void retranslateUi(QFrame *SendCoinsEntry)
    {
        ...
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to (e.g. EfWhpGkYFejmqZa1CWwjFuYHxSdL6rjWBA)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
