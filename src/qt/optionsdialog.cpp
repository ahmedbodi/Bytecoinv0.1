    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new ByteCoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->bytecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Bytecoin."), QMessageBox::Ok);
