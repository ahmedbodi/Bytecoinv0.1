...
#ifndef _BYTECOINRPC_H_
#define _BYTECOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // ByteCoin is not connected
...
/**
 * ByteCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
