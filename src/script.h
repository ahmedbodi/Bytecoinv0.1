...
#ifndef H_BYTECOIN_SCRIPT
#define H_BYTECOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CByteCoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, ByteCoin always counted CHECKMULTISIGs
